...
export async function sendVolunteerConfirmation(to, { eventTitle, formattedDate, location, slotTitle, slotTime, cancelUrl }) {
  await resend.emails.send({
    ...
    html: `
      ...
      <p>See you there!</p>
      ${cancelUrl ? `<p style="margin-top:1.5rem;font-size:0.85em;color:#888;">Need to cancel? <a href="${cancelUrl}">Click here to cancel your signup</a>.</p>` : ''}
    `,
  });
}
